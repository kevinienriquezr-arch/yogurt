...
import com.kevin.demo.domain.repository.TemperatureLogRepository;
import com.kevin.demo.domain.repository.YogurtBatchRepository;
import com.kevin.demo.domain.service.TemperatureControlService;
import com.kevin.demo.dto.MonitoringDTO;
...
@Tag(name = "Monitorización y Dashboard", description = "Panel de control para vigilar la temperatura y el estado general de producción")
public class MonitoringController {
    ...
    @Operation(summary = "Obtener lotes activos", description = "Devuelve los lotes que están en proceso (HEATING, COOLING, INCUBATING, REFRIGERATING)")
    ...
    @Operation(summary = "Resumen de temperatura de un lote", description = "Devuelve estadísticas de temperatura (actual, máxima, mínima, promedio) de un lote")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Resumen de temperatura obtenido"),
    ...
    @Operation(summary = "Obtener historial de temperatura", description = "Devuelve los registros de temperatura de un lote, opcionalmente filtrados por rango de tiempo")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Historial de temperatura obtenido"),
    ...
    @Operation(summary = "Obtener datos del Dashboard", description = "Devuelve conteos y estadísticas generales para la pantalla principal")
